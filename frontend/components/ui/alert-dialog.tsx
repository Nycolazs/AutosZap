  ...
  return (
    <AlertDialogPrimitive.Portal>
      ...
      <AlertDialogPrimitive.Content
        className={cn(
          'glass-panel fixed inset-x-0 bottom-0 z-50 max-h-[calc(100dvh-0.5rem)] w-full overflow-y-auto overscroll-contain rounded-t-[28px] p-4 pb-[calc(1rem+env(safe-area-inset-bottom))] sm:left-1/2 sm:top-1/2 sm:max-h-[calc(100dvh-1.5rem)] sm:w-[min(460px,calc(100vw-2rem))] sm:-translate-x-1/2 sm:-translate-y-1/2 sm:rounded-[28px] sm:p-6',
          className,
        )}
        {...props}
      />
