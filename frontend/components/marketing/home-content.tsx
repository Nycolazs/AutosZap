      ...
      <div className="relative z-10">
        ...
        <section className="mx-auto max-w-7xl px-4 pb-14 pt-10 sm:px-8 sm:pb-20 sm:pt-24 lg:pt-32">
          ...
          >
            <motion.div
              variants={heroItem}
              className="mb-5 inline-flex items-center gap-1.5 rounded-full border border-blue-500/20 bg-blue-500/10 px-3 py-1 text-[11px] font-medium text-blue-400 sm:gap-2 sm:px-4 sm:py-1.5 sm:text-xs"
            >
            ...
            <motion.h1
              variants={heroItem}
              className="font-heading text-[2rem] font-bold leading-[1.1] tracking-tight sm:text-[clamp(2.4rem,5.5vw,4.2rem)] sm:leading-[1.05]"
            >
            ...
            <motion.div
              variants={heroItem}
              className="mt-6 flex flex-col items-center gap-2.5 sm:mt-8 sm:flex-row sm:justify-center sm:gap-3"
            >
        ...
        <section id="funcionalidades" className="scroll-mt-16 mx-auto max-w-7xl px-4 py-14 sm:px-8 sm:py-20">
          <ScrollReveal className="mx-auto mb-8 max-w-2xl text-center sm:mb-12">
          ...
          >
            {features.map((feat) => {
              ...
              return (
                <motion.div key={feat.title} variants={gridItem} className={`${glassHover} p-5 sm:p-6`}>
        ...
        <section className="mx-auto max-w-7xl px-4 py-14 sm:px-8 sm:py-20">
          ...
          >
            {benefits.map((item) => {
              ...
              return (
                <motion.div key={item.title} variants={gridItem} className={`${glassHover} p-4 text-center sm:p-6`}>
